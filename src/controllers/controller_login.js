...
const notifyAdmins = async (newUser) => {
  ...
  try {
      ...
      const approveLink = `https://healthlabbackend.vercel.app/api/router_login/approve/${newUser._id}`;
      const denyLink = `https://healthlabbackend.vercel.app/api/router_login/deny/${newUser._id}`;
